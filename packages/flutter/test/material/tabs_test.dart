...
void main() {
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      IconButton(
                        ...
                        onPressed: () {
                          setState(() {
                            tabTextContent = List<String>.from(tabTextContent)..add('Tab ${tabTextContent.length + 1}');
                          });
                        },
                      ),
                      IconButton(
  ...
  testWidgets('Material3 - TabAlignment updates tabs alignment (scrollable TabBar)', (
    ...
    double tabTwoRight = tabStartOffset + kTabLabelPadding.horizontal + tabOneRect.width + kTabLabelPadding.left + tabTwoRect.width;
    ...
    tabOneLeft = kTabLabelPadding.left + tabStartOffset;
    expect(tabOneRect.left, equals(tabOneLeft));
    tabTwoRight = tabStartOffset + kTabLabelPadding.horizontal + tabOneRect.width + kTabLabelPadding.left + tabTwoRect.width;
    expect(tabTwoRect.right, equals(tabTwoRight));
  });
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      double tabTwoLeft = tabBar.width - tabStartOffset - kTabLabelPadding.horizontal - tabOneRect.width - kTabLabelPadding.right - tabTwoRect.width;
      ...
      expect(tabOneRect.right, equals(tabOneRight));
      tabTwoLeft = tabBar.width - kTabLabelPadding.horizontal - tabOneRect.width - kTabLabelPadding.left - tabTwoRect.width;
      expect(tabTwoRect.left, equals(tabTwoLeft));
      ...
      expect(tabOneRect.right, equals(tabOneRight));
      tabTwoLeft = tabBar.width - tabStartOffset - kTabLabelPadding.horizontal - tabOneRect.width - kTabLabelPadding.right - tabTwoRect.width;
      expect(tabTwoRect.left, equals(tabTwoLeft));
    },
  );
