...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Finder menuMaterial = find.ancestor(of: find.byType(SingleChildScrollView), matching: find.byType(Material)).first;
      ...
      final Finder updatedMenu = find.ancestor(of: find.byType(SingleChildScrollView), matching: find.byType(Material)).first;
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Finder menuView = find.ancestor(of: find.byType(SingleChildScrollView), matching: find.byType(Padding)).first;
      ...
      final Finder updatedMenu = find.ancestor(of: find.byType(SingleChildScrollView), matching: find.byType(Padding)).first;
  ...
  testWidgets(
      'Down key and up key can navigate while focused when a label text '
  ...
  testWidgets(
      'Down key and up key can navigate while focused when a label text contains '
