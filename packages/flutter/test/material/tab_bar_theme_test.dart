...
Widget buildTabBar({
  ...
  Widget tabBar = secondaryTabBar ? TabBar.secondary(tabs: tabs, isScrollable: isScrollable, controller: controller) : TabBar(tabs: tabs, isScrollable: isScrollable, controller: controller);
...
void main() {
  ...
  testWidgets('Tab bar defaults (primary)', (WidgetTester tester) async {
    ...
    final double tabTwoRight = tabStartOffset + kTabLabelPadding.horizontal + tabOneRect.width + kTabLabelPadding.left + tabTwoRect.width;
  ...
  testWidgets('Material3 - Tab bar label padding overrides theme label padding', (
    ...
    expect(
      tabTwoRect.right,
      equals(
        tabStartOffset + horizontalThemePadding + tabOneRect.width + tabTwoRect.width + (horizontalThemePadding / 2),
      ),
    );
    expect(tabTwoRect.top, equals(verticalPadding));
    expect(tabTwoRect.bottom, equals(tabBar.bottom - verticalPadding - indicatorWeight));
